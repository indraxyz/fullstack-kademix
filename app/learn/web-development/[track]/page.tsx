...
export default async function WebDevTrackPage({ params }: { params: { track: string } }) {
      ...
      <Card className="border-dashed border-2">
        <CardContent className="pt-6 flex flex-col items-center justify-center text-center min-h-[300px] text-muted-foreground">
          ...
          <p className="max-w-md">
            We are working hard to prepare the best learning materials for {track.replace("-", " ")} level web development. 
