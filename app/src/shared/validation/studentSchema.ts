...
export const studentFormSchema = z
  .object({
    ...
    studyProgram: z.enum(studyProgramOptions).optional().nullable(),
    codingTrack: z.enum(codingTrackOptions).optional().nullable(),
  })
  .refine(
    (data) =>
      data.studyProgram !== "Coding" || data.codingTrack != null,
    {
      path: ["codingTrack"],
      message: "Coding track is required when study program is Coding",
    }
  );
